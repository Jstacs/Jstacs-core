...
/**/	
	...
	public static abstract class AbstractTransitionElement implements Cloneable, Storable {
		 ...
		 * 
		 * @see AbstractTransitionElement#BasicHigherOrderTransition.AbstractTransitionElement(int[], int[], double[], double[])
		 */
		 ...
		 * 
		 * @see Transition#getGraphizNetworkRepresentation(NumberFormat, String, boolean)
		 ...
		 * 
		 * @see Transition#getLogPriorTerm()
		 */
		public double getLogPriorTerm() {
		 ...
		 * @param sequencePosition the position within the sequence
		 * 
		 * @see TrainableTransition#addToStatistic(int, int, int, double, Sequence, int)
		 * @see #statistic
		 * @see #resetStatistic()
		 ...
		 * @see #resetStatistic()
		 * @see #addToStatistic(int, double, Sequence, int)
		 * @see TrainableTransition#estimateFromStatistic()
		 */
		public void estimateFromStatistic() {
			if( states.length > 0 ) {
				logNorm = 0;
		 ...
		 * @see #drawParametersFromStatistic()
		 * @see #addToStatistic(int, double, Sequence, int)
		 * @see TransitionWithSufficientStatistic#resetStatistic()
		 */
		public void resetStatistic() {
