...
public class StrandTrainSM extends AbstractMixtureTrainSM {
	...
	/**
	 * Creates a new {@link StrandTrainSM}. This constructor can be used for any
	 * algorithm since it takes all necessary values as parameters.
	 * 
	 * @param model
	 *            the model building the basis of the {@link StrandTrainSM}, if
	 ...
	 */
	protected StrandTrainSM( TrainableStatisticalModel model, int starts, boolean estimateComponentProbs, double[] componentHyperParams,
		...
		super( model.getLength(),
				new TrainableStatisticalModel[]{ model },
				null,
				2,
				starts,
	 ...
	 *             if the <code>models</code> can not be cloned
	 * 
	 * @see StrandTrainSM#StrandTrainSM(TrainableStatisticalModel, int, boolean,
	 *      double[], double,
	 *      Algorithm, double,
	 ...
	 * @see Algorithm#EM
	 */
	public StrandTrainSM( TrainableStatisticalModel model, int starts, double[] componentHyperParams, double alpha, TerminationCondition tc, Parameterization parametrization )
																																			throws CloneNotSupportedException,
																																			IllegalArgumentException,
																																			WrongAlphabetException {
	 ...
	 * @see Algorithm#EM
	 */
	public StrandTrainSM( TrainableStatisticalModel model, int starts, double forwardStrandProb, double alpha, TerminationCondition tc, Parameterization parametrization )
																																		throws CloneNotSupportedException,
																																		IllegalArgumentException,
																																		WrongAlphabetException {
	 ...
	 *      Parameterization, int,
	 *      int, BurnInTest )
	 * @see Algorithm#GIBBS_SAMPLING
	 */
	public StrandTrainSM( TrainableStatisticalModel model, int starts, double[] componentHyperParams, int initialIteration, int stationaryIteration,
	 ...
	 * @see Algorithm#GIBBS_SAMPLING
	 */
	public StrandTrainSM( TrainableStatisticalModel model, int starts, double forwardStrandProb, int initialIteration, int stationaryIteration,
						BurnInTest burnInTest ) throws CloneNotSupportedException, IllegalArgumentException, WrongAlphabetException {
		this( model,
				starts,
				false,
	 ...
	 * new {@link StrandTrainSM} out of its XML representation.
	 * 
	 * @param stringBuff
