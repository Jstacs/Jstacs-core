...
public class SharedStructureMixture extends MixtureTrainSM {
	 ...
	 *      ModelType, byte, int, boolean, double[], double, TerminationCondition)
	 */
	 ...
	 * 
	 * @see ModelType
	 * @see MixtureTrainSM#MixtureTrainSM(int,
	 * 		de.jstacs.sequenceScores.statisticalModels.trainable.TrainableStatisticalModel[], 
	 * 		int, boolean, double[], double[], Algorithm, double,
	 * 		TerminationCondition, Parameterization, int, int, de.jstacs.sampling.BurnInTest)
	 */
