...
public abstract class HomogeneousTrainSM extends DiscreteGraphicalTrainSM {
	 ...
	 * Creates a new {@link HomogeneousTrainSM} out of its XML representation.
	 * 
	 * @param stringBuff
	 *            the XML representation as {@link StringBuffer}
	 * 
	 * @throws NonParsableException
	 *             if the {@link HomogeneousTrainSM} could not be reconstructed
	 ...
	 * 
	 * @see HomogeneousTrainSM#train(DataSet[], double[][])
	 */
	 ...
	 * {@link AlphabetContainer} of a (sub){@link Sequence}
	 ...
	 * 
	 * @see DiscreteGraphicalTrainSM#check(Sequence, int, int)
	 */
	@Override
	 ...
	 * {@link de.jstacs.sequenceScores.statisticalModels.trainable.TrainableStatisticalModel#getLogProbFor(Sequence, int, int)} after
	 * the method {@link HomogeneousTrainSM#check(Sequence, int, int)} has been
	 * invoked.
	 * 
	 * @param sequence
	 *            the {@link Sequence}
	 ...
	 * 
	 * @see HomogeneousTrainSM#check(Sequence, int, int)
	 * @see de.jstacs.sequenceScores.statisticalModels.trainable.TrainableStatisticalModel#getLogProbFor(Sequence, int, int)
	 */
	...
	protected class HomCondProb extends Constraint {
		 ...
		 * inner instance of a {@link HomogeneousTrainSM}.
		 * 
		 * @param old
		 *            the old instance to be cloned
		 * 
		 * @see HomCondProb#HomCondProb(int[],int)
		 */
		...
		/* (non-Javadoc)
		 * @see de.jstacs.sequenceScores.statisticalModels.trainable.discrete.Constraint#estimateUnConditional(int, int, double, boolean)
		 */
		@Override
