 ...
 * Using this statistic the interfaces {@link TrainableTransition} and {@link SamplingTransition}
 * can be used to estimate the parameters (cf. {@link TrainableTransition#estimateFromStatistic()})
 * or to draw new parameters (cf. {@link de.jstacs.sampling.SamplingFromStatistic#drawParametersFromStatistic()}).
 * 
 * @author Jens Keilwagen
 * 
 * @see TrainableTransition
 * @see SamplingTransition
 */
