...
public class MSPClassifier extends GenDisMixClassifier {
	 ...
	 *            the parameter set for the classifier
	 * @param prior
	 *            the prior that shall be used; the learning principle depends on the prior: if the prior is <code>null</code> or {@link DoesNothingLogPrior} then MCL is used otherwise MSP
	 * @param score
	 *            the {@link DifferentiableSequenceScore}s for the classes
	 * 
	 * @throws CloneNotSupportedException
