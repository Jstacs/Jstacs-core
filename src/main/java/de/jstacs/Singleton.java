...
public interface Singleton {
	...
	public static class SingletonHandler {
		 ...
		 *  
		 * @throws SecurityException forwarded from {@link Class#getField(String)}
		 * @throws NoSuchFieldException forwarded from {@link Class#getField(String)}
		 * @throws IllegalArgumentException forwarded from {@link Field#get(Object)}
		 * @throws IllegalAccessException forwarded from {@link Field#get(Object)}
		 */
