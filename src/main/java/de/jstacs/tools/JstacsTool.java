...
public interface JstacsTool {
	 ...
	 * 
	 * Currently, this information is only used in the {@link Galaxy} environment, but may be used
	 ...
	 * {@link GalaxyAdaptor#getDefaultExtension(Class)}. If this method returns <code>null</code>, the output format
