...
public class ContinuousAlphabet extends Alphabet {
	...
	public static class ContinuousAlphabetParameterSet extends AlphabetParameterSet {
		 ...
		 * values.
		 * @see AlphabetParameterSet#AlphabetParameterSet(Class)
		 */
		 ...
		 * 
		 * @see ContinuousAlphabetParameterSet#ContinuousAlphabetParameterSet()
		 */
		 ...
		 *             not be parsed)
		 * 
		 * @see AlphabetParameterSet#AlphabetParameterSet(StringBuffer)
		 * @see de.jstacs.Storable
		 */
