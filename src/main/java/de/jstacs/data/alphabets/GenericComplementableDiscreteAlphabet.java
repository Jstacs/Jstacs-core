...
public class GenericComplementableDiscreteAlphabet extends ComplementableDiscreteAlphabet {
	...
	public static class GenericComplementableDiscreteAlphabetParameterSet extends DiscreteAlphabetParameterSet {
		...
		/**
		 * The standard constructor for the interface {@link de.jstacs.Storable}.
		 * Creates a new {@link GenericComplementableDiscreteAlphabetParameterSet} out of its XML
		 * representation.
		 * 
		 * @param representation
		 *            the XML representation as {@link StringBuffer}
		 * 
		 * @throws NonParsableException
		 *             if the {@link GenericComplementableDiscreteAlphabetParameterSet} could not be
		 *             reconstructed out of the XML representation (the
		 *             {@link StringBuffer} <code>representation</code> could
		 *             not be parsed)
		 * 
		 * @see AlphabetParameterSet#AlphabetParameterSet(StringBuffer) Alphabet.AlphabetParameterSet#AlphabetParameterSet(StringBuffer)
		 * @see de.jstacs.Storable
		 */
