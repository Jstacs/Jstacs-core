...
public abstract class Sequence<T> implements Comparable<Sequence<T>> {
	...
	/**
	* Returns the {@link SequenceAnnotation} of this {@link Sequence} that has type <code>type</code> and identifier <code>identifier</code>.
	* 
	...
	*/
	...
	/**
	* Returns the {@link SequenceAnnotation} no. <code>idx</code> of this {@link Sequence} that has type <code>type</code>
	* 
	...
	*/
	...
	/**
	 * Returns the number of {@link SequenceAnnotation}s of type <code>type</code> for this {@link Sequence}.
	 * @param type the type
	 ...
	 * create a {@link de.jstacs.data.DataSet} where every {@link Sequence} has the same
	 ...
	 * 
	 * @see CompositeSequence#CompositeSequence(AlphabetContainer, Sequence, int[], int[])
	 */
	 ...
	 * @return the {@link CompositeSequence}
	 * 
	 * @see CompositeSequence#CompositeSequence(Sequence, int[], int[])
	 */
	 ...
	 * 
	 * @see Sequence#getSubSequence(AlphabetContainer, int, int)
	 */
	 ...
	 * @return the subsequence
	 * 
	 * @see SubSequence#SubSequence(AlphabetContainer, Sequence, int, int)
	 */
	 ...
	 * @return the subsequence
	 * 
	 * @see SubSequence#SubSequence(Sequence, int, int)
	 */
	 ...
	 * the {@link Sequence} in its original {@link de.jstacs.data.alphabets.Alphabet}).
	 * 
	...
	/**
	 * Returns a {@link String} representation of the {@link Sequence} (normally
	 * the {@link Sequence} in its original {@link de.jstacs.data.alphabets.Alphabet}) beginning at
	...
	/**
	 * Returns a {@link String} representation of the {@link Sequence} (normally
	 * the {@link Sequence} in its original {@link de.jstacs.data.alphabets.Alphabet}) between
	...
	/**
	 * This method returns the Hamming distance between the current {@link Sequence} and <code>seq</code>.
	...
	protected static class CompositeSequence<T> extends RecursiveSequence<T> {
		 ...
		 * {@link de.jstacs.data.DataSet} of {@link CompositeSequence}s. With this constructor
	...
	public static class SubSequence<T> extends RecursiveSequence<T> {
		...
		/**
		 * This constructor should be used if one wants to create a
		 * {@link de.jstacs.data.DataSet} of {@link SubSequence}s of defined length. With this
