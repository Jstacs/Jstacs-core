...
public class DataSet implements Iterable<Sequence>{
	 ...
	 * {@link DataSet} and all composite {@link Sequence}s
	 ...
	 * 
	 * @see PartitionMethod
	 * @see PartitionMethod#PARTITION_BY_NUMBER_OF_ELEMENTS
	 * @see PartitionMethod#PARTITION_BY_NUMBER_OF_SYMBOLS
	 */
	 ...
	 * @see ToolBox#parseHashSet2IndexHashtable(HashSet)
	 */
	...
	public static class WeightedDataSetFactory {
		 ...
		 *             {@link WeightedDataSetFactory#WeightedDataSetFactory(SortOperation, DataSet[], double[][], int)}
		 *             )
		 * 
		 * @see WeightedDataSetFactory#WeightedDataSetFactory(SortOperation, DataSet[], double[][], int)
		 */
