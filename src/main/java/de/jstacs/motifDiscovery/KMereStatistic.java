...
public final class KMereStatistic {
	 ...
	 * 
	 * @return a {@link WeightedDataSetFactory} containing all <code>k</code>-mers and
	 ...
	 *             if something went wrong
	 *             
	 * @see KMereStatistic#getAbsoluteKMereFrequencies(DataSet, int, boolean, SortOperation)
