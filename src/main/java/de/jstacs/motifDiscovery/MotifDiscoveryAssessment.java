...
public class MotifDiscoveryAssessment {
	...
	/**
	 * This method provides some score arrays that can be used in {@link de.jstacs.classifiers.performanceMeasures.AbstractPerformanceMeasure} to determine some
	 ...
	 * Both dimensions are sorted and can be directly used in the methods of {@link de.jstacs.classifiers.performanceMeasures.AbstractPerformanceMeasure}.
