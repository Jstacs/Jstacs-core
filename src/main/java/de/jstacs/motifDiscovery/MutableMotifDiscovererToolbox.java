...
public final class MutableMotifDiscovererToolbox extends MotifDiscovererToolBox {
	 ...
	 *
	 * @see MutableMotifDiscovererToolbox#clearHistoryArray(History[][])
	 * @see MutableMotifDiscovererToolbox#optimize(DifferentiableSequenceScore[], DiffSSBasedOptimizableFunction, byte, AbstractTerminationCondition, double, StartDistanceForecaster, SafeOutputStream, boolean, History[][], int[][], KindOfParameter, boolean)
	 */
